...
Define el ABM de carreras académicas para el tenant. ADMIN puede crear, editar, listar, obtener y cambiar el estado (activa/inactiva) de carreras. Una carrera inactiva no admite la creación de nuevas cohortes.
