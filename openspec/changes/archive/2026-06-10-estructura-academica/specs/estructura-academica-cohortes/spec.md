...
Define el ABM de cohortes académicas. Cada cohorte pertenece a una carrera y a un tenant. ADMIN puede crear, editar, listar, obtener y cambiar el estado de cohortes. La creación de una cohorte requiere que la carrera esté activa.
