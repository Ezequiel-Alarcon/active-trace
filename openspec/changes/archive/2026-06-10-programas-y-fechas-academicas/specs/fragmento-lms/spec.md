...
Define la generación de un fragmento HTML con las fechas académicas formateadas para una materia y cohorte específicas, listo para copiar y pegar en el aula virtual del LMS. No es una integración automática — es contenido para uso manual por parte del docente o coordinador.
