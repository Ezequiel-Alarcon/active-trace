# Capability: `rbac-role-catalogue`

> Defines the managed catalog of roles. Each tenant has its own role instances. The system seeds 7 domain roles as the universal baseline.
