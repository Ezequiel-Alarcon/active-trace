# Capability: `rbac-require-permission-guard`

> `require_permission("modulo:accion")` FastAPI dependency. Every protected endpoint declares the permission it requires. The guard checks the user's effective permissions and returns 403 if missing.
