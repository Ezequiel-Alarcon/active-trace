...
| PA-22 | Las claves de Plus son un catálogo fijo definido por el programa/sistema, común a todas las instituciones; cada materia se asocia a una clave existente o queda sin Plus | [04_modelo_de_datos.md](04_modelo_de_datos.md), [05_reglas_de_negocio.md](05_reglas_de_negocio.md) |
| PA-23 | El Plus se acumula por comisión activa: N comisiones de la misma clave generan `N × Plus(clave, rol)`, sin tope inicial y con la misma lógica para PROFESOR, TUTOR, COORDINADOR y NEXO | [05_reglas_de_negocio.md](05_reglas_de_negocio.md), [07_flujos_principales.md](07_flujos_principales.md) |
